...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [19] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_def, 3, 0, 2), SHIFT(9),
  [22] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_def, 3, 0, 2), SHIFT(8),
  [25] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_def, 3, 0, 2), SHIFT(2),
  [28] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_def, 3, 0, 2), SHIFT(14),
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_let, 6, 0, 3),
  [33] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_let, 6, 0, 3), SHIFT(9),
  [36] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym_let, 6, 0, 3), SHIFT(8),
  [39] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_let, 6, 0, 3), SHIFT(2),
  [42] = {.entry = {.count = 2, .reusable = false}}, REDUCE(sym_let, 6, 0, 3), SHIFT(14),
  ...
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expr, 1, 0, 0),
  [57] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__expr, 1, 0, 0),
  ...
  [67] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expr, 3, 0, 0),
  [69] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__expr, 3, 0, 0),
